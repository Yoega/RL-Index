for dataset_name in "theoremqa_questions" "theoremqa_theorems" "leetcode"
do
    CUDA_VISIBLE_DEVICES=0 python emb_and_index_LM.py --dataset $dataset_name --model "Alibaba-NLP/gte-Qwen1.5-7B-instruct" \
